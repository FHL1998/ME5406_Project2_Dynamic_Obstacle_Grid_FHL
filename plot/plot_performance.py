...
csv_ppo_lstm2 = pandas.read_csv('csvs/ppo_lstm2.csv')
csv_ppo_lstm4 = pandas.read_csv('csvs/ppo_lstm4.csv')
csv_a2c = pandas.read_csv('csvs/a2c.csv')
csv_a2c_lstm2 = pandas.read_csv('csvs/a2c_lstm2.csv')
csv_a2c_lstm4 = pandas.read_csv('csvs/a2c_lstm4.csv')
# csv_ppo = pandas.read_csv('csvs/ppo.csv')
